...
export const PALETTE_DERIVED: [string, DerivedSpec][] = [
  ...
  ['brand-primary-light-l15', { source: 'brand-primary-light', fn: 'lighten', amount: 15 }],
  ...
  ['error-d5', { source: 'error', fn: 'darken', amount: 5 }],
  ...
  ['gray-light-d6', { source: 'gray-light', fn: 'darken', amount: 6 }],
  ['gray-light-a20', { source: 'gray-light', fn: 'alpha', amount: .2 }],
